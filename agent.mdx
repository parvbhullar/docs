...
A **model** typically refers to a customizable AI agent or system designed for specialized tasks such as handling conversations, automating support, or performing workflow actions. Here, you define how your AI starts and manages conversations using the system prompt.

<img
  src="./images/AgentModel.png"
  alt="Agent Model"
  width="500"
  style="margin-left:50px;"
/>
...
<img
  src="./images/AgentModelStep1.png"
  alt="Agent Model Step 1"
  width="500"
  style="margin-left:50px;"
/>
...
<img
  src="./images/AgentModelStep2.png"
  alt="Agent Model Step 2"
  width="500"
  style="margin-left:50px;"
/>
...
<img
  src="./images/AgentModelStep3-1.png"
  alt="Agent Model Step 3-1"
  width="500"
  style="margin-left:50px;"
/>
...
<img
  src="./images/AgentModelStep3-4.png"
  alt="Agent Model Step 3-4"
  width="500"
  style="margin-left:50px;"
/>
...
<img
  src="./images/AgentModelStep3-5.png"
  alt="Agent Model Step 3-5"
  width="500"
  style="margin-left:50px;"
/>
...
<img
  src="./images/AgentModelStep3-6.png"
  alt="Agent Model Step 3-6"
  width="500"
  style="margin-left:50px;"
/>
...
<img
  src="./images/AgentModelStep4-1.png"
  alt="Agent Model Step 4-1"
  width="500"
  style="margin-left:50px;"
/>
...
<img
  src="./images/AgentModelStep4-2.png"
  alt="Agent Model Step 4-2"
  width="500"
  style="margin-left:50px;"
/>
...
<img
  src="./images/AgentModelStep5.png"
  alt="Agent Model Step 5"
  width="500"
  style="margin-left:50px;"
/>
...
<img
  src="./images/AgentModelStep6.png"
  alt="Agent Model Step 6"
  width="500"
  style="margin-left:50px;"
/>
...
<img
  src="./images/AgentMOdelStep7.png"
  alt="Agent Model Step 7"
  width="500"
  style="margin-left:50px;"
/>
...
<img
  src="./images/AgentVPStep1-1.png"
  alt="Agent VP Step 1-1"
  width="500"
  style="margin-left:50px;"
/>

<img
  src="./images/AgentVPStep1-2.png"
  alt="Agent VP Step 1-2"
  width="500"
  style="margin-left:50px;"
/>
...
<img
  src="./images/AgentVPStep6-1.png"
  alt="Agent VP Step 6-1"
  width="500"
  style="margin-left:50px;"
/>
...
<img
  src="./images/AgentAdvancedStep1-1.png"
  alt="Agent Advanced Step 1"
  width="500"
  style="margin-left:50px;"
/>

<img
  src="./images/AgentAdvancedStep1-2.png"
  alt="Agent Advanced Step 1-2"
  width="500"
  style="margin-left:50px;"
/>
...
<img
  src="./images/AgentAdvancedStep2-1.png"
  alt="Agent Advanced Step 2-1"
  width="500"
  style="margin-left:50px;"
/>
...
<img
  src="./images/AgentAdvancedStep2-2.png"
  alt="Agent Advanced Step 2-2"
  width="500"
  style="margin-left:50px;"
/>
...
<img
  src="./images/AgentAnalysisStep1.png"
  alt="Agent Analysis Step 1"
  width="500"
  style="margin-left:50px;"
/>
...
<img
  src="./images/AgentAnalysisStep2.png"
  alt="Agent Analysis Step 2"
  width="500"
  style="margin-left:50px;"
/>
...
<img
  src="./images/AgentAnalysisStep3-1.png"
  alt="Agent Analysis Step 3-1"
  width="500"
  style="margin-left:50px;"
/>
...
<img
  src="./images/AgentAnalysisStep3-2.png"
  alt="Agent Analysis Step 3-2"
  width="500"
  style="margin-left:50px;"
/>
